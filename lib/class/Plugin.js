...
class Plugin {
    ...
    async loadPlugin(filePath) {
        try {
            ...
            // Register commands
            if (pluginModule.command && pluginModule.function) {
    ...
    validatePlugin(pluginModule, pluginName) {
        ...
        if (!pluginModule.function || typeof pluginModule.function !== 'function') {
            throw new Error(`Plugin ${pluginName} missing or invalid 'function' property`);
        }
            ...
            const commandData = {
                ...
                execute: async (bot, message, args) => {
                    try {
                        ...
                        await plugin.module.function(message, args, bot);
