...
class Client extends EventEmitter {
    ...
    async connect() {
        try {
            ...
            // Create WhatsApp socket with better session handling
        ...
        this.socket.ev.on('connection.update', async (update) => {
            ...
            if (connection === 'close') {
                ...
                if (statusCode === DisconnectReason.badSession) {
                    ...
                    logger.info('🔄 Connection closed, reconnecting in 3 seconds...')
                    ...
                    logger.error('❌ Session ended - Device logged out')
                    ...
                    logger.info('🔄 Connection timed out, reconnecting in 5 seconds...')
